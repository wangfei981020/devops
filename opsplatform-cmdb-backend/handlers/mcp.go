...
var mcpTools = []mcpTool{
	...
	{"resource_usage", "实际资源使用率(Prometheus):CPU/内存时序", "/api/obs/usage", []mcpParam{{"cluster_id", "integer", "集群ID", false}, {"target", "string", "pod/workload/node", false}, {"namespace", "string", "命名空间", false}, {"name", "string", "资源名", false}, {"metric", "string", "cpu/mem", false}, {"minutes", "integer", "时间窗分钟", false}, {"query", "string", "原始PromQL(可选)", false}}, false},
