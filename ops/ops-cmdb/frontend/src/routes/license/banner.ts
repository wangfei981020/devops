...
export function licenseBanner(info: LicenseInfo | undefined): BannerSpec | null {
  ...
  switch (info.status) {
    case 'grace':
      ...
      return {
        tone: 'warn',
        key: 'common:license.graceBanner',
    ...
    case 'finger_mismat':
      return {
        tone: 'warn',
        key: 'common:license.fingerprintBanner',
        params: { days: GRACE_DAYS },
      }

    case 'expired':
      return { tone: 'bad', key: 'common:license.expiredBanner', params: {} }

    case 'lapsed':
      return { tone: 'bad', key: 'common:license.lapsedBanner', params: { days: 30 } }

    case 'not_licensed':
      return { tone: 'bad', key: 'common:license.notLicensedBanner', params: {} }
    ...
    case 'active':
      ...
      if (info.shouldRemind && info.daysUntilExpiry !== null) {
        return {
          tone: 'info',
          key: 'common:license.remindBanner',
    ...
    default: {
      ...
      return {
        tone: 'warn',
        key: 'common:license.unknownStatus',
