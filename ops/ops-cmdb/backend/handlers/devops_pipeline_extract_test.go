...
var viteFailLog = []string{
	"> test-baccarat-pc-c@0.0.1 build /workspace/source",
	"> vite build",
	...
	"ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL @game-framework/test-baccarat-pc-c@0.0.1 build: `vite build`",
	"Exit status 1",
...
// 复现实测某次构建的形态（81 条全落在 L333~L698，L3148 的 error during build 没进来）。
