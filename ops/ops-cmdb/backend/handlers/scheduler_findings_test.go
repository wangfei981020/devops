...
func TestSummarizeFindings(t *testing.T) {
	items := []TaskFinding{
		...
		{Level: "warning", Target: "infra-a · PVC logging/loki-chunks-cache-0", Value: "87.0%"},
		{Level: "warning", Target: "infra-a · PVC logging/es-warm-v2-0", Value: "85.2%"},
	}
	...
	one := SummarizeFindings([]TaskFinding{{Target: "infra-b"}}, 3)
	if one != "infra-b" {
