...
//
// 起因：classic-baccarat-game.k8s-app-uat.com 实际走 Cloudflare（dig 出来是
// 104.18.20.2），但全链路页 CDN 一栏是空的。原因不是没关联，是**数据压根没有**：
//
//	classic-baccarat-game.k8s-app-uat.com  →  cf-host.k8s-app-uat.com
//	                                       →  app-uat-istio-gateway.uatcfzone.com  ← 只有这跳在 CF
//	                                       →  104.18.20.2
//
// 前两跳属于 k8s-app-uat.com，而那个域在 CMDB 里 dns_provider 为空（没接 DNS 数据源），
