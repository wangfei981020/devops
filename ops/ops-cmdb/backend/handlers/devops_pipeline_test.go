...
// 取自 test-lobby-h5-s-game-frontend #50 的真实构建日志（前端 vite/pnpm 编译失败）。
...
/home/jenkins/agent/workspace/apps/test-lobby/src/utils/lobbyDiffUtil.ts:220:16: ERROR: Multiple exports with the same name "resolveRoomBetLimitRuleGroupId"
/home/jenkins/agent/workspace/apps/test-lobby/src/utils/lobbyDiffUtil.ts:220:16: ERROR: The symbol "resolveRoomBetLimitRuleGroupId" has already been declared
 ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  @game-framework/test-lobby@0.0.1 build: ` + "`vite build`" + `
Exit status 1
[Pipeline] }
