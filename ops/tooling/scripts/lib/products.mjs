 ...
 * 三个守卫原本各写着一份硬编码清单：
 *
 *   check-i18n-usage.mjs   SRC_DIRS = ['ops-cmdb/frontend/src', 'ops-sso/frontend/src']
 *   check-hardcoded-colors.mjs  TARGETS = [..., 'ops-cmdb/frontend/src']
 *   check-perm-codes.mjs   nav: 'ops-cmdb/frontend/src/layouts/nav.ts'
 *
 * 旁边还写着注释「新产品加进来时补一行」—— 而 ops-alert 建出来之后
...
/** 所有产品目录名，如 ['ops-alert', 'ops-cmdb', 'ops-sso'] */
...
/** 有前端的产品的 src 目录（相对 ROOT），如 ['ops-alert/frontend/src', ...] */
...
/** 有后端的产品的 backend 目录（相对 ROOT），如 ['ops-cmdb/backend', ...] */
