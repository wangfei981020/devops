...
func TestParse(t *testing.T) {
	cases := []struct {
		...
		// 生产真实串
		{"harbor.slileisure.com/g32/wallet-client-backend:20260519082034-58ac8c3-114",
			"wallet-client-backend", "20260519082034-58ac8c3-114", "harbor.slileisure.com", "g32", 114, true},
		...
		{"dev-harbor.slleisure.com/g32-test/atmosphere-frontend:20260730083740-100",
			"atmosphere-frontend", "20260730083740-100", "dev-harbor.slleisure.com", "g32-test", 100, true},
		// 🔴 registry 带端口：冒号有两个，按第一个切会全错
		{"localhost:8070/opsplatform-dev/ops-cmdb-backend:v0.92.5",
			"ops-cmdb-backend", "v0.92.5", "localhost:8070", "opsplatform-dev", -1, true},
		// 🔴 Harbor 返回的尾巴必须剥掉
		{"harbor.slileisure.com/g32/bi-task-backend:20260812090855-08e4b67-39 [3 item(s) in total]",
			"bi-task-backend", "20260812090855-08e4b67-39", "harbor.slileisure.com", "g32", 39, true},
		...
		// pod 的 imageID 形态
		{"localhost:8070/opsplatform-dev/ops-cmdb-backend@sha256:949b8b92efce",
			"ops-cmdb-backend", "", "localhost:8070", "opsplatform-dev", -1, false},
		// 多级项目路径
...
func TestKeyStableAcrossOrgs(t *testing.T) {
	imgs := []string{
		"harbor.slileisure.com/g32/wallet-client-backend:20260519082034-58ac8c3-114",
		"harbor.a-corp.com/g32/wallet-client-backend:20260421031122-a71bd04-109",
		"harbor.b-corp.com/xyz-platform/wallet-client-backend:20260519082034-58ac8c3-114",
		"harbor.c-corp.com/g32-cn/wallet-client-backend:20260519082034-58ac8c3-114 [1 item(s) in total]",
	}
