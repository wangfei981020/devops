...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'incidents', name: 'Incidents', component: () => import('@/views/ResponseRecordsView.vue'), meta: { title: '响应记录' } },
      ...
      { path: 'table-alert', name: 'TableAlert', component: () => import('@/views/TableAlertView.vue'), meta: { title: '桌台维护告警' } },
