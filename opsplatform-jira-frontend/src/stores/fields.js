...
export const useFieldsStore = defineStore('fields', () => {
  ...
  function getSavedColumns() {
    try {
      const saved = localStorage.getItem('opsplatform-jira-columns')
  ...
  function saveColumns(cols) {
    localStorage.setItem('opsplatform-jira-columns', JSON.stringify(cols))
  }

  function getSavedStatFields() {
    try {
      const saved = localStorage.getItem('opsplatform-jira-stat-fields')
      if (saved) return JSON.parse(saved)
    } catch (e) { /* ignore */ }
  ...
  function saveStatFields(fields) {
    localStorage.setItem('opsplatform-jira-stat-fields', JSON.stringify(fields))
  }
